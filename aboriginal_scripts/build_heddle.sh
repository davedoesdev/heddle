...
EOF
  ...
  exec linux.uml "ubd0=$HDB" "ubd1=$HDC" rootfstype=tmpfs initrd=initrd.img init=/init.uml mem="${BUILD_MEM}M" con0=fd:3,fd:4 ssl0=fd:0,fd:1 console=ttyS0 "heddle_arch=$ARCH" eth0=slirp 3>/dev/null 4>&1
else
