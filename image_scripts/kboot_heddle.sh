...
kvm -m 2048 -no-reboot -kernel "build/system-image-${1:-x86_64}/bzImage" -initrd "$IMG_DIR/initrd.img" -hda "$IMG_DIR/heddle.img" -append "root=/dev/hda3 rw init=/dist/init.sh console=ttyS0,9600n8 console=tty0"
