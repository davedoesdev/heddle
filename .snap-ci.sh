...
PATH="$PATH:$PWD"
cd ..
curl "http://ftp.debian.org/debian/pool/main/s/slirp/slirp_1.0.17.orig.tar.gz" | tar -zx
cd slirp-1.0.17
curl "http://ftp.debian.org/debian/pool/main/s/slirp/slirp_1.0.17-7.debian.tar.gz" | tar -zx
